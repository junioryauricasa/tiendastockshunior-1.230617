						...
						<div class="panel-body">
							<div class="col-md-6">
				                <form action="?action=<?php echo $gam->intidproducto > 0 ? 'actualizar' : 'registrar'; ?>" method="POST" class="pure-form pure-form-stacked" style="margin-bottom:30px;" enctype="multipart/form-data">
				                    ...
				                    <!--input class="form-control" type="text" name="nvchcantidad" value="<?php echo $gam->__GET('nvchcantidad'); ?>" placeholder='Ingrese Proveedor' style="width:100%;" required/>
				                    <br-->

				                    <!--select persona-->
				                    <select name="nvchcantidad" style='text-transform:uppercase' class="form-control" id="">
                                          <?php dameproveedor(); ?>
                                    </select>
